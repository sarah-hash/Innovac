...
function Slid() {
  ...
  const options = ['Le Coching', 'Les ateliers techniques éducatifs', 'Les formations professionnelles certifiées'];
            ...
            <div className="container h-100 d-flex align-items-center justify-content-center">
              <div className="row justify-content-center">
                <div className="col-lg-8">
                  ...
                  <h1 className="display-1 my-3 fw-bold text-white">Inspiring novative center (Innova'c)</h1>
                </div>
              </div>
            </div>
          </div>
